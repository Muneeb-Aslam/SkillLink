...
export default function Header(data: any) {
   ...
   const [profileImg, setProfileImg] = useState<any>(clientData.profileImage);
               ...
               <div className="flex ml-4 justify-start items-start py-4 relative gap-4 h-48">
                  {edit || !profileImg ? (
                     <>
                        <label
                           htmlFor="profile"
                           className="w-40 h-40 absolute -top-20 left-4 border-8 border-white rounded-[50%] bg-blue flex justify-center items-center text-blackish font-bold"
                        >
                           Choose Image
                        </label>
                        <input
                  ...
                  <div className="ml-48 flex flex-col justify-start items-start gap-4">
                     <Input
                        type="text"
